...
public class JGrafo {
    ...
    public JGrafo(int numVertices, boolean direcionado) {
        this(numVertices, numVertices, direcionado);
    }

    public JGrafo(int numVertices, int numArestas) {
        this(numVertices, numArestas, true);
    }

    public JGrafo(int numVertices, int numArestas, boolean direcionado) {
